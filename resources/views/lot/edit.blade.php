...
@section('content')
    ...
    <section class="lot_add_form px-3 old_form">
        ...
        <form action={{ route("lot.edit", ["id" => $lot->id]) }} method="POST" class="mt-3">
            @csrf()
            <div class="form_group mb-2">
                <div class="row">
                    ...
                    <div class="col-8">
                        <input class="w-100" type="text" name="lot_no" id="lot_no" value={{ old("lot_no", @$lot->lot_no) }}>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <select class="w-100" name="party_id" id="party_id">
                            ...
                            <option value="1" {{ old("party_id", @$lot->party_id) == 1 ? "selected" : "" }} >1</option>
                        </select>
                        <span class="text-danger">
                            @error('party_id')
                                {{ $message }}
            ...
            <div class="form_group mb-2">
                <div class="row">
                    ...
                    <div class="col-8">
                        <input class="w-100" type="number" name="rate" id="rate" value={{ old("rate", $lot->rate) }}>
                    </div>
                </div>
            </div>
            <div class="form_group mb-2">
                <div class="row">
                    ...
                    <div class="col-8">
                        <input class="w-100" type="date" name="date" id="date" value={{ old("date", $lot->date) }}>
                    </div>
                </div>
            </div>
